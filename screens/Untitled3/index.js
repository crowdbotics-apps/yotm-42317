...
const Untitled3 = () => {
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><View style={styles.gjFhJVHD}><ImageBackground style={styles.yPkzDirs} source={{
        ...
        }} resizeMode="cover"></ImageBackground><Text style={styles.RnIDZFxK}>{"Welcome"}</Text><Pressable onPress={() => {
          navigation.navigate("Untitled4", {});
        }}><View style={styles.lSVOEBNT}><Pressable onPress={() => {
              navigation.navigate("Untitled4");
