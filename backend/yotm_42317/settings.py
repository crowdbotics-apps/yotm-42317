"""
Django settings for yotm_42317 project.
...
WSGI_APPLICATION = 'yotm_42317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yotm_42317 API",
    "DESCRIPTION": "API documentation for yotm_42317 App",
    "VERSION": "v1",
}
